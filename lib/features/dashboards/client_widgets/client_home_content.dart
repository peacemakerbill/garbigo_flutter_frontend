...
class ClientHomeContent extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ClientHomeContent> createState() => _ClientHomeContentState();
}
            ...
            FutureBuilder<List<UserModel>>(
              ...
              builder: (context, snapshot) {
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (_, i) => _CollectorCard(collector: collectors[i]),
                );
              },
            ),
          ],
...
class _StatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double padding = mobile ? 18 : tablet ? 20 : 24;
    final double iconSize = mobile ? 24 : tablet ? 28 : 32;
    final double valueSize = mobile ? 24 : tablet ? 28 : 34;
    final double titleSize = mobile ? 13 : tablet ? 14 : 15;
          ...
          children: [
            CircleAvatar(
              ...
              child: collector.profilePictureUrl.isEmpty
                  ? Icon(Icons.person, size: isMobile ? 28 : 32)
                  : null,
            ),
