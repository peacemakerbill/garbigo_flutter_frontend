...
class FinanceSidebar extends ConsumerWidget {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _SidebarButton(icon: Icons.receipt_long, title: 'Invoices', index: 1, currentIndex: currentIndex, onTap: onIndexChanged),
          _SidebarButton(icon: Icons.payment, title: 'Payments', index: 2, currentIndex: currentIndex, onTap: onIndexChanged),
          _SidebarButton(icon: Icons.analytics, title: 'Reports', index: 3, currentIndex: currentIndex, onTap: onIndexChanged),
          _SidebarButton(icon: Icons.settings, title: 'Settings', index: 4, currentIndex: currentIndex, onTap: onIndexChanged),
          const Divider(),
